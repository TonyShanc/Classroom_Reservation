...
<div class="container">
    <nav class="nav-list">
        ...
        <a href="/Classroom_Reservation/jsp/revise_compr_info.jsp" class="nav-item" id="nav-item5"><span
                class="iconfont">&#xe751;</span>
            <span class="item-info">修改信息</span></a>
        <%} %>
        <%if (session.getAttribute("loginType").equals(3) == false) { %>
        <a href="/Classroom_Reservation/jsp/revise_user_info.jsp" class="nav-item" id="nav-item5"><span
                class="iconfont">&#xe751;</span>
            <span class="item-info">修改信息</span></a>
        <%} %>

        <a href="/Classroom_Reservation/jsp/list_classroom.jsp" class="nav-item" id="nav-item6">
            <span class="iconfont">&#xe610;</span>
...
<%@ include file="/jsp/report_fault_sub.jsp" %>
</body>
</html>