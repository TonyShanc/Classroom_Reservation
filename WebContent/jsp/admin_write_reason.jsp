...
<%
    ...
    session.setAttribute("reviewType", request.getParameter("reviewType"));
%>
...
<form action="/Classroom_Reservation/ReviewChangeStateServlet" name="ReviewChangeState" method="post">
    <br>
    <br>
    <div style="text-align: center">
        <textarea name="reason" rows="8" cols="50" placeholder="请输入理由"></textarea>
        <br>
