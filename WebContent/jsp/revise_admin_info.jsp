...
<div class="container">
    <nav class="nav-list">
        ...
        <a href="/Classroom_Reservation/OrderReviewServlet" class="nav-item" id="nav-item5">
            <span class="iconfont">&#xe751;</span>
            <span class="item-info">预约审核</span>
        </a>
        <a href="/Classroom_Reservation/jsp/view_user_info.jsp" class="nav-item" id="nav-item6">
            <span class="iconfont">&#xe610;</span>
...
<%@ include file="/jsp/revise_admin_info_sub.jsp" %>
...
<script type="text/javascript" src="/Classroom_Reservation/script/room_select.js"></script>
</body>
</html>